...
| PR-05 | SAIH 2025: informasi lomba | Program | prod `/gala-kreasi/informasi-lomba-saih-2025` | Program ▸ `saih-gala-kreasi` | 🟡 | fix | PAUD and SD contest links dead |
| PR-06 | SAIH 2025: pengumuman pemenang | Page | prod `/gala-kreasi/pengumuman-pemenang-2025` | Program ▸ `saih-gala-kreasi` (status note) | — | remove | Prod page said "Konten belum tersedia" |
| PR-07 | Gala Kreasi Video 2024 | Archive | prod `/gala-kreasi/gala-kreasi-2024` | Program ▸ `saih-gala-kreasi` | 🟡 | add | 4 Tujuan Kegiatan and 3 downloads missing (R3) |
| PR-08 | Gala Kreasi 2024: pengumuman pemenang | Page | prod `/gala-kreasi/gala-kreasi-2024-pemenang` | — | ⬜ | decide | Loads on prod; not scraped into `docs/` (R4) |
